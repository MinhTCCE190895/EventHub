...
description: Quản lý context thông qua tóm tắt (compression) các phần việc đã hoàn thiện và quy tắc Research-first để tự tra cứu trước khi đề xuất API .NET 9.
---
...
- Khi đối mặt với các hàm API, thư viện mới của **.NET 9** hoặc **EF Core 9.0**:
  ...
  - Đảm bảo code đề xuất khớp 100% với đặc tả kỹ thuật của nền tảng .NET 9 ổn định nhất.
